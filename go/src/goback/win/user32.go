...
func init() {
	...
	postThreadMessage = MustGetProcAddress(libuser32, "PostThreadMessageA")
...
func PostThreadMessage(idThread uint32, msg uint32, wParam, lParam uintptr) uintptr {
	res, _, _ := syscall.Syscall6(postThreadMessage, 4, uintptr(idThread),
		uintptr(msg),
		wParam,
		lParam,
		0,
